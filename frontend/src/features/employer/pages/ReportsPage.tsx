...
const statusConfig = [
  { label: 'Pending', values: ['Pending', 'For Review', 'Under Review', 'Endorsed', 'Offer Received'], color: '#4b4395' },
  { label: 'Accepted', values: ['Accepted'], color: '#211578' },
  { label: 'Interview Scheduled', values: ['Interview Scheduled'], color: '#ffb83e' },
  { label: 'Rejected', values: ['Rejected', 'Offer Declined'], color: '#dc0000' },
  { label: 'Withdrawn', values: ['Withdrawn'], color: '#e25555' },
  { label: 'Expired', values: ['Expired'], color: '#7a7692' },
]
...
export function ReportsPage() {
  ...
  return <main className={styles.pageContainer}>
    ...
    <section className={styles.mainContent}>
      <section><h2 className={styles.summaryTitle}>Summary</h2><div className={styles.summaryGrid}><SummaryCard label="Total Referrals" value={summary.total} /><SummaryCard label="Accepted" value={summary.accepted} /><SummaryCard label="Interview Scheduled" value={summary.forInterview} /><SummaryCard label="Rejected" value={summary.rejected} /></div></section>
      ...
      <article className={styles.printReport}>
        ...
        <section className={styles.printTitle}><h1>Referral Summary Report</h1><p>ABC Company · Generated {generatedAt}</p></section>
