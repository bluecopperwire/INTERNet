...
import { AdminE2eEnvironment } from './admin/support/admin-e2e-environment';
import { AdminFixtureFactory, type PesoFixture } from './admin/support/fixture-factory';
...
describe('PESO Create Employer endpoint', () => {
  ...
  it('creates an employer with websiteUrl = null and district = null', async () => {
    ...
    console.log('Nulls test Response status:', res.status);
    console.log('Nulls test Response body:', JSON.stringify(res.body, null, 2));
