...
export const MOCK_RECENT_APPLICANTS: Applicant[] = [
  {
    ...
    applicationDate: 'August 14, 2026', referralDate: 'August 15, 2026', reviewStatus: 'For Review', historyStatus: 'For Review (Employer)',
    status: 'Pending',
    canHide: false,
  ...
  },
  {
    ...
    applicationDate: 'August 13, 2026', referralDate: 'August 14, 2026', reviewStatus: 'Under Review', historyStatus: 'Offer Accepted (Student)',
    status: 'Accepted',
    canHide: false,
  ...
  },
  {
    ...
    applicationDate: 'August 12, 2026', referralDate: 'August 13, 2026', reviewStatus: 'For Interview', historyStatus: 'For Interview (Employer)',
  ...
  },
  {
    ...
    applicationDate: 'August 10, 2026', referralDate: 'August 11, 2026', reviewStatus: 'Under Review', historyStatus: 'Rejected (Employer)',
    status: 'Rejected',
    canHide: true,
