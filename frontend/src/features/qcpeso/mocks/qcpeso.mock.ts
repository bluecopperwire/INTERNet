...
export const MOCK_QCPESO_REVIEW_APPLICANTS: QCPesoReviewApplicant[] = [
  { id: 'QCA-001', studentName: 'Maria Santos', company: 'Metropolitan Tech Solutions', jobTitle: 'Full Stack Web Developer Intern', program: 'BS Information Technology', yearLevel: '3rd Year', dateApplied: 'August 14, 2026', status: 'Pending', canHide: false, email: 'maria.santos@gmail.com', phone: '09171234567', address: 'Commonwealth Avenue, Batasan Hills, Quezon City', school: 'Quezon City University', requiredHours: 200, availableDays: 'Monday, Tuesday, Wednesday, Thursday, Friday', availableStartingDate: 'August 22, 2026', opportunityId: 'OPP-001' },
  { id: 'QCA-002', studentName: 'Kyle Ethan Porciuncula', company: 'Quezon City IT Department', jobTitle: 'UI/UX Design Intern', program: 'BS Computer Science', yearLevel: '3rd Year', dateApplied: 'August 12, 2026', status: 'Pending', canHide: false, email: 'kyleporciuncula@gmail.com', phone: '09123456789', address: '309 Katipunan Ave, Loyola Heights, Quezon City', school: 'Polytechnic University of the Philippines', requiredHours: 250, availableDays: 'Monday, Tuesday, Wednesday, Thursday, Friday', availableStartingDate: 'August 25, 2026', opportunityId: 'OPP-002' },
  { id: 'QCA-003', studentName: 'Angelica Reyes', company: 'CloudCore Systems', jobTitle: 'Software QA Intern', program: 'BS Information Systems', yearLevel: '4th Year', dateApplied: 'August 10, 2026', status: 'Pending', canHide: false, email: 'angelica.reyes@gmail.com', phone: '09223334455', address: 'Aurora Boulevard, Cubao, Quezon City', school: 'Far Eastern University', requiredHours: 240, availableDays: 'Monday, Tuesday, Wednesday, Thursday, Friday', availableStartingDate: 'August 28, 2026', opportunityId: 'OPP-003' },
  { id: 'QCA-004', studentName: 'Juan Dela Cruz', company: 'Metropolitan Tech Solutions', jobTitle: 'Full Stack Web Developer Intern', program: 'BS Computer Science', yearLevel: '4th Year', dateApplied: 'August 9, 2026', status: 'Rejected', canHide: true, email: 'juan.delacruz@gmail.com', phone: '09189876543', address: 'Tandang Sora Avenue, Quezon City', school: 'University of the Philippines Diliman', requiredHours: 300, availableDays: 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', availableStartingDate: 'September 1, 2026', opportunityId: 'OPP-001' },
]

export const MOCK_QCPESO_REFERRALS: QCPesoReferral[] = [
  { id: 'REF-001', studentName: 'Maria Santos', company: 'Metropolitan Tech Solutions', jobTitle: 'Full Stack Web Developer Intern', referralDate: 'August 15, 2026', companyResponse: 'For Interview', studentResponse: 'Pending', workflowStatus: 'Interview Scheduled', canHide: false, email: 'maria.santos@gmail.com', phone: '09171234567', address: 'Commonwealth Avenue, Batasan Hills, Quezon City' },
  { id: 'REF-002', studentName: 'Kyle Ethan Porciuncula', company: 'Quezon City IT Department', jobTitle: 'UI/UX Design Intern', referralDate: 'August 13, 2026', companyResponse: 'Accepted', studentResponse: 'Accepted', workflowStatus: 'Accepted', canHide: false, email: 'kyleporciuncula@gmail.com', phone: '09123456789', address: '309 Katipunan Ave, Loyola Heights, Quezon City' },
  { id: 'REF-003', studentName: 'Angelica Reyes', company: 'CloudCore Systems', jobTitle: 'Software QA Intern', referralDate: 'August 11, 2026', companyResponse: 'Pending', studentResponse: 'Pending', workflowStatus: 'Pending', canHide: false, email: 'angelica.reyes@gmail.com', phone: '09223334455', address: 'Aurora Boulevard, Cubao, Quezon City' },
]
...
export const MOCK_QCPESO_ATTENDANCE: QCPesoAttendanceRecord[] = [
  ...
  { id: 'ATT-000A', internshipId: 'INT-002', studentName: 'Maria Santos', company: 'Quezon City IT Department', jobTitle: 'UI/UX Design Intern', date: '2026-08-22', timeIn: '8:09 AM', timeOut: '5:00 PM', status: 'Present', hoursRendered: 8 },
  ...
  { id: 'ATT-002', internshipId: 'INT-001', studentName: 'Kyle Ethan Porciuncula', company: 'Metropolitan Tech Solutions', jobTitle: 'Full Stack Web Developer Intern', date: '2026-08-15', timeIn: '8:11 AM', timeOut: '5:00 PM', status: 'Present', hoursRendered: 8 },
