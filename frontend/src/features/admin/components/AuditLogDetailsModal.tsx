        ...
        return (
          <>
            ...
            <div className={styles.infoRow}>
              ...
              <div className={styles.infoValue}>{details.changedDate ? formatTimestamp(details.changedDate) : 'N/A'}</div>
            </div>
          </>
        )
        ...
        return (
          <>
            ...
            <div className={styles.infoRow}>
              ...
              <div className={styles.infoValue}>{details.reviewDate ? formatTimestamp(details.reviewDate) : 'N/A'}</div>
            </div>
          </>
        )
      default:
        // Generic fallback for standard logs
        return (
          <>
            <div className={styles.infoRow}>
              <div className={styles.infoLabel}>Details</div>
              <div className={styles.infoValue}>{JSON.stringify(details)}</div>
            </div>
          </>
        )
    }
